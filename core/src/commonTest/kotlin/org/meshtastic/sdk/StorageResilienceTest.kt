...
class StorageResilienceTest {
    ...
    fun heartbeatPersistenceRoundTrips() = runTest {
        ...
        val peerId = 0x1234
        val peerPacket = org.meshtastic.proto.MeshPacket.Builder().also { wb ->wb.from = peerId; wb.to = 7; wb.id = 1}.build()
        val fromRadio = org.meshtastic.proto.FromRadio.Builder().also { wb ->wb.packet = peerPacket}.build()
