...
public suspend fun AdminApi.setDeviceConfig(block: Config.DeviceConfig.() -> Config.DeviceConfig): AdminResult<Unit> =
    setConfigSection(Config.DeviceConfig.Builder().build(), block) {
...
): AdminResult<Unit> = setConfigSection(Config.PositionConfig.Builder().build(), block) {
    Config.Builder().also { wb ->
        wb.position = it
    }.build()
}
...
public suspend fun AdminApi.setPowerConfig(block: Config.PowerConfig.() -> Config.PowerConfig): AdminResult<Unit> =
    setConfigSection(Config.PowerConfig.Builder().build(), block) {
        Config.Builder().also { wb ->
            wb.power = it
        }.build()
    }
...
): AdminResult<Unit> = setConfigSection(Config.NetworkConfig.Builder().build(), block) {
    Config.Builder().also { wb ->
        wb.network = it
    }.build()
}
...
): AdminResult<Unit> = setConfigSection(Config.DisplayConfig.Builder().build(), block) {
    Config.Builder().also { wb ->
        wb.display = it
    }.build()
}
...
public suspend fun AdminApi.setLoraConfig(block: Config.LoRaConfig.() -> Config.LoRaConfig): AdminResult<Unit> =
    setConfigSection(Config.LoRaConfig.Builder().build(), block) {
        Config.Builder().also { wb ->
            wb.lora = it
        }.build()
    }
...
): AdminResult<Unit> = setConfigSection(Config.BluetoothConfig.Builder().build(), block) {
    Config.Builder().also { wb ->
        wb.bluetooth = it
    }.build()
}
...
): AdminResult<Unit> = setConfigSection(Config.SecurityConfig.Builder().build(), block) {
    Config.Builder().also { wb ->
        wb.security = it
    }.build()
}
...
): AdminResult<Unit> = setModuleConfigSection(ModuleConfig.MQTTConfig.Builder().build(), block) {
...
): AdminResult<Unit> = setModuleConfigSection(ModuleConfig.SerialConfig.Builder().build(), block) {
    ModuleConfig.Builder().also { wb ->
        wb.serial = it
    }.build()
}
...
): AdminResult<Unit> = setModuleConfigSection(ModuleConfig.RangeTestConfig.Builder().build(), block) {
    ModuleConfig.Builder().also { wb ->
        wb.range_test = it
    }.build()
}
...
): AdminResult<Unit> = setModuleConfigSection(ModuleConfig.TelemetryConfig.Builder().build(), block) {
    ModuleConfig.Builder().also { wb ->
        wb.telemetry = it
    }.build()
}
...
): AdminResult<Unit> = setModuleConfigSection(ModuleConfig.AudioConfig.Builder().build(), block) {
    ModuleConfig.Builder().also { wb ->
        wb.audio = it
    }.build()
}
